...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
    ...
    **For codebase research:**
    - All codebase agents try `ccc search` (semantic code search) first to accelerate discovery — if it fails due to missing initialization, they fall back to grep/glob immediately without indexing
