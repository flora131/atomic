...
argument-hint: 'Include the path where your execution plan is in the [execPlanPath] placeholder.'
handoffs:
  - label: Implement Plan
    agent: Implement
    prompt: Implement the plan outlined in the execution plan: [execPlanPath].
    send: false
---
