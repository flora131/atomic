...
| `structured-output.ts` | Schema-specific `structured_output` override using the canonical factory | `createStructuredOutputTool`, `registerTool`, terminating tool results |
