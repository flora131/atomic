...
| Related Specs          | `specs/2026-02-09-ralph-loop-enhancements.md`               |
...
- **Unused Infrastructure**: `watchTasksJson()` was designed for exactly this use case (cited in `specs/2026-02-09-ralph-loop-enhancements.md:126`) but has zero consumers. The `TaskListIndicator` component is fully functional but only used inline during streaming.
...
- **Related Spec**: `specs/2026-02-09-ralph-loop-enhancements.md` — Prior spec for replacing `RalphFeature` with `TodoItem`, `watchTasksJson()` design
