...
- [specs/streaming-architecture-event-bus-migration.md](../specs/streaming-architecture-event-bus-migration.md) — Foundational event bus design; established the BusEventType system (originally 26 types, now 30 with 4 workflow types), 16ms frame-aligned batching, and single event pathway
- [specs/streaming-event-bus-spec-compliance-remediation.md](../specs/streaming-event-bus-spec-compliance-remediation.md) — Spec compliance fixes for the event bus
- [specs/codebase-architecture-modularity-refactor.md](../specs/codebase-architecture-modularity-refactor.md) — Module boundary refactoring including EventBus coupling
- [specs/sdk-v2-first-unified-layer.md](../specs/sdk-v2-first-unified-layer.md) — SDK v2-first unified layer design
