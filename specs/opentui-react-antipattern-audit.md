...
- [ ] We will NOT restructure the event bus or streaming pipeline. Those are separate efforts tracked in [specs/event-bus-callback-elimination-sdk-event-types.md](event-bus-callback-elimination-sdk-event-types.md) and [specs/streaming-architecture-event-bus-migration.md](streaming-architecture-event-bus-migration.md).
- [ ] We will NOT rewrite the test suite. Test improvements are tracked in [specs/test-suite-design-85-percent-coverage.md](test-suite-design-85-percent-coverage.md).
...
3. **Consider future:** If the event bus callback elimination spec ([specs/event-bus-callback-elimination-sdk-event-types.md](event-bus-callback-elimination-sdk-event-types.md)) is implemented, many of these refs will become unnecessary
...
### Related Specs
- [specs/codebase-architecture-modularity-refactor.md](codebase-architecture-modularity-refactor.md) — Broader modularity refactor
- [specs/event-bus-callback-elimination-sdk-event-types.md](event-bus-callback-elimination-sdk-event-types.md) — Event bus callback elimination
- [specs/streaming-architecture-event-bus-migration.md](streaming-architecture-event-bus-migration.md) — Streaming event bus migration
- [specs/test-suite-design-85-percent-coverage.md](test-suite-design-85-percent-coverage.md) — Test suite design
