...
- [ ] We will NOT change the worker/task loop (planner → orchestrator cycle). That is a separate loop (ref: `specs/ralph-loop-enhancements.md`).
...
| [specs/ralph-workflow-redesign.md](ralph-workflow-redesign.md)                                                                                        | Broader redesign proposal (compatible — same stage structure)                        |
| [specs/ralph-loop-enhancements.md](ralph-loop-enhancements.md)                                                                                        | Worker/task loop enhancements (separate concern)                                     |
