...
- [specs/workflow-sdk-standardization.md](../specs/workflow-sdk-standardization.md) — Unified `WorkflowSDK` entry point
- [specs/pluggable-workflows-sdk.md](../specs/pluggable-workflows-sdk.md) — Entity registry normalization
- [specs/atomic-v2-rebuild.md](../specs/atomic-v2-rebuild.md) — Ground-up rebuild reducing graph engine from 8.7K to ~1K lines
- [specs/ralph-workflow-redesign.md](../specs/ralph-workflow-redesign.md) — Conductor model replacing compiled-graph engine
- [specs/unified-workflow-execution.md](../specs/unified-workflow-execution.md) — Generic workflow execution replacing hardcoded dispatch
