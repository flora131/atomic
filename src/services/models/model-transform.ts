...
/**
 * OpenCode Provider type from SDK provider/config metadata
 */
...
/**
 * OpenCode Model type from SDK provider/config metadata
 */
...
/**
 * Create a Model from OpenCode SDK provider metadata
