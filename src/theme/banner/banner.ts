...
import { LOGO, LOGO_TRUE_COLOR, LOGO_MIN_COLS, LOGO_MIN_ROWS } from "@/theme/banner/constants.ts";
import { supports256Color, supportsTrueColor } from "@/services/system/detect.ts";
