 ...
 * concrete class lives in `@oh-my-pi/pi-coding-agent`; we cannot import
 * that runtime type from a `.ts` extension shipped to oh-my-pi without
 ...
 *
 * Mapping rationale (see `node_modules/@oh-my-pi/pi-coding-agent
