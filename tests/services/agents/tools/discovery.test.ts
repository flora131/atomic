...
import { ToolRegistry, setToolRegistry } from "@/services/agents/tools/registry.ts";
import { registerCustomTools, getDiscoveredCustomTools } from "@/services/agents/tools/discovery.ts";
import { mkdtemp, mkdir, rm, writeFile } from "fs/promises";
import { join, resolve } from "path";
import { tmpdir } from "os";

// Absolute path to zod so temp tool files can import it outside node_modules
const ZOD_PATH = resolve(process.cwd(), "node_modules/zod").replace(/\\/g, "/");
