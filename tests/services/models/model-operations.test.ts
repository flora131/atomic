...
import { CLAUDE_ALIASES, UnifiedModelOperations, type AgentType, type SetModelResult } from "@/services/models/model-operations.ts";
...
function createMockOpenCodeProviderModel(
  overrides: Partial<{
    name: string;
...
describe("UnifiedModelOperations - listAvailableModels with mocks", () => {
  ...
  test("caches models after first call to listAvailableModels", async () => {
    ...
    // Second call should reuse the session cache.
